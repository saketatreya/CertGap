...
\item {\bf Experiment statistical significance}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Per-seed AUROCs are reported with paired-Wilcoxon $p$-values across $237$ seeds (\Cref{tab:per-env-auroc}); the dominance counts and pooled $p$-values are reported in \Cref{sec:results}.
...
\item {\bf Broader impacts}
    ...
    \item[] Justification: The paper is a methodological diagnostic for actor--critic RL with no direct application path to deployed systems; we identify no specific positive or negative societal impacts.
...
\item {\bf Declaration of LLM usage}
    ...
    \item[] Answer: \answerNA{}
    \item[] Justification: LLMs were not part of the methodology; any use was limited to writing and editing, which the NeurIPS policy does not require to be declared.
